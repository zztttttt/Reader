 ...
 */
export type NitroViewWrappedCallback<T extends Function | undefined> = {
    f: T;
};
type WrapFunctionsInObjects<Props> = {
    [K in keyof Props]: Props[K] extends Function ? NitroViewWrappedCallback<Props[K]> : Props[K] extends Function | undefined ? NitroViewWrappedCallback<Props[K]> : Props[K];
};
/**
 ...
 */
export declare function callback<T>(func: T): T extends (...args: any[]) => any ? NitroViewWrappedCallback<T> : T;
export {};
